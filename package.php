<?php
/**
 * This is the package.xml generator for Structures_Grammar
 *
...
$packagexml->setPackage('Structures_Grammar');
$packagexml->setSummary('Data structure package for describing a formal grammar');
$packagexml->setDescription(<<<EOS
Structures_Grammar is a data structure class used in defining formal grammars, as described by Noam Chomsky. 

Check the wikipedia article for the definition of a formal grammar: http://en.wikipedia.org/wiki/Formal_grammar
EOS
);
